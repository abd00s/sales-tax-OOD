...
RSpec.describe Parser do
  ...
  describe 'extract_item_details' do
    it 'Extracts details of parsed input and instantiates product with attributes' do
      ...
      expect(parser.extract_item_details("1 book at 12.49")[0].price).to eq(12.49)
      ...
      expect(parser.extract_item_details("1 music CD at 14.99")[1].price).to eq(14.99)
      ...
      expect(parser.extract_item_details("1 chocolate bar at 0.85")[2].price).to eq(0.85)
      ...
      expect(parser.extract_item_details("1 imported box of chocolates at 10.00")[3].price).to eq(10.00)
      ...
      expect(parser.extract_item_details("1 imported bottle of perfume at 47.50")[4].price).to eq(47.50)
      ...
      expect(parser.extract_item_details("1 imported bottle of perfume at 27.99")[5].price).to eq(27.99)
      ...
      expect(parser.extract_item_details("1 bottle of perfume at 18.99")[6].price).to eq(18.99)
      ...
      expect(parser.extract_item_details("1 packet of headache pills at 9.75")[7].price).to eq(9.75)
      ...
      expect(parser.extract_item_details("1 box of imported chocolates at 11.25")[8].price).to eq(11.25)
